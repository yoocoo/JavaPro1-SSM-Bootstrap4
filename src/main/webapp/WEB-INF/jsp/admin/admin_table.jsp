...
<head>
    ...
    <%--<link rel="stylesheet" href="https://cdn.datatables.net/buttons/1.5.1/css/buttons.bootstrap4.min.css" type="text/css"/>--%>
    <%--<link rel="stylesheet" href="https://cdn.datatables.net/select/1.2.5/css/select.bootstrap4.min.css" type="text/css"/>--%>
</head>
<body>
            ...
            <div class="padding">
                <div class="box">
                    ...
                    <div class="table-responsive">
                        <table
                                <%--ui-jp="dataTable" --%>
                                id="tables" cellspacing="0" width="100%"
                               <%--ui-options="{--%>
