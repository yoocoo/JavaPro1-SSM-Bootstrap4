...
(function (c) {
    ...
    c.extend(!0, c.fn.dataTable.Editor.classes, {
        header: {wrapper: "DTE_Header modal-header"},
        body: {wrapper: "DTE_Body modal-body"},
        footer: {wrapper: "DTE_Footer modal-footer"},
        form: {tag: "form-horizontal", button: "btn btn-default"},
        field: {
            wrapper: "DTE_Field",
    ...
    a.Editor.display.bootstrap = c.extend(!0, {}, a.Editor.models.displayController, {
        init: function (a) {
            ...
            a.on("open.dtebs", function (b, a) {
                (a === "inline" || a === "bubble") &&
                c("div.DTE input:not([type=checkbox]):not([type=radio]), div.DTE select, div.DTE textarea").addClass("form-control")
            });
            return b
        }, open: function (a, e, d) {
            if (b._shown) d && d(); else {
                ...
                c("input:not([type=checkbox]):not([type=radio]), select, textarea", b._dom.content).addClass("form-control")
            }
        }, close: function (a, d) {
            if (b._shown) {
