 ...
 * 时间： 2017/7/5.
 * 作者： 王娇
 * 说明： 基于JqueryDatatable 的Datatable 工具类
 */
public class DataTablePageUtil<T> {
	...
	//private DatatableFileDto files = new DatatableFileDto();
	...
	//public DatatableFileDto getFiles() {
	//	return files;
	//}
    //
	//public void setFiles(DatatableFileDto files) {
	//	this.files = files;
	//}
}
